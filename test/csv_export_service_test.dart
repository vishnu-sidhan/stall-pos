    ...
    test('generates orders CSV with payment audit fields', () {
      final orders = [
        StallOrder(
          token: 1,
          items: const [
            OrderItem(itemId: '1', itemName: 'Masala Chai', price: 20.0, quantity: 2),
          ],
          timestamp: testDate,
          isCompleted: false,
          isPaid: false,
        ...
        StallOrder(
          token: 2,
          items: const [
            OrderItem(itemId: '1', itemName: 'Veg Samosa', price: 30.0, quantity: 1, paidQuantity: 1),
            OrderItem(itemId: '2', itemName: 'Chai', price: 20.0, quantity: 1, paidQuantity: 1),
          ],
        ...
        StallOrder(
          token: 3,
          items: const [
            OrderItem(itemId: '1', itemName: 'Paneer Roll', price: 70.0, quantity: 2, paidQuantity: 1),
          ],
